	...
	<div class="container grid grid-cols-1 gap-8 lg:gap-20 md:px-10 md:pb-10 lg:grid-cols-2">
		<div class="flex flex-col items-center mx-12 lg:mx-0">
			<div class="relative text-center">
				...
				<p class="px-6 py-1 text-lg italic"> I absolutely love staying a few days at the DECK b and b. The owners are always around and help in any way possible. The place itself is gorgeous and there is a ton to do.</p>
		...
		<div class="flex flex-col items-center max-w-lg mx-12 lg:mx-0">
			<div class="relative text-center">
				...
				<p class="px-6 py-1 text-lg italic">The best food on the island and one of the best views around. Close enoght to everything  but far enough away to feel like you are in the jungle. We had a great time and will be back.</p>
