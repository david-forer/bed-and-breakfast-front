    ...
    return (
      <div>
        <form onSubmit={this.handleSubmit}>
          ...
          <label className="pb-2 text-sm font-bold text-gray-800">Attraction Name: </label>
          <input
            type="text"
            placeholder="Name"
          ...
          />
          <br />
          <label  className="pb-2 text-sm font-bold text-gray-800">Attraction Description: </label>
          <input
            type="textarea"
          ...
          />
          <br />
          <label  className="pb-2 text-sm font-bold text-gray-800">Attraction Location: </label>
          <input
            type="text"
          ...
          />
          <br />
            <input className="bg-indigo-500 transition duration-150 ease-in-out hover:bg-indigo-600 rounded text-white lg:w-1/4 w-1/2 py-4 text-sm focus:outline-none mt-6 " type="submit" />
            </div>
            </div>
        </form>
      </div>
